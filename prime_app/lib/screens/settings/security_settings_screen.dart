            ...
            child: Column(
              children: [
                ...
                if (enabled && biometricHardwareAvailable) ...[
                  Divider(color: PrimeColors.border, height: 28),
                  Row(
                    children: [
                      Container(
                        width: 38,
                ...
                if (enabled) ...[
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.password, size: 16, color: PrimeColors.mutedForeground),
                          const SizedBox(width: 10),
                          Expanded(
                            child: Text('Change PIN', style: PrimeTheme.text(fontSize: 13, fontWeight: FontWeight.w600)),
                          ),
                          Icon(Icons.chevron_right, size: 18, color: PrimeColors.mutedForeground),
                        ],
                      ),
                    ),
                  ),
